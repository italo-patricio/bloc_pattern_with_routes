...
class ResponsiveContainer extends StatelessWidget {
  ...
  const ResponsiveContainer({Key key, this.alignment, this.padding, this.margin, this.child, @required this.widthPercent, @required this.heightPercent, this.decoration}) : super(key: key);
